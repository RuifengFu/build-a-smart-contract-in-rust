        ...
        const tests = [];
    tests.push('__wbgt_is_public_0');
tests.push('__wbgt_returns_result_1');
tests.push('__wbgt_returns_context_2');
tests.push('__wbgt_pushes_clicker_and_increments_total_clicks_3');
main(tests);
